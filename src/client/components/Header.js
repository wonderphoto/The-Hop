    ...
    <nav className="bg-green-300 border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        {JSON.stringify(user) !== JSON.stringify({}) ? (
          <div className="flex items-center md:order-2">
            ...
            <div className="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
              ...
              <ul className="py-1" aria-labelledby="dropdown">
                ...
                <li>
                  <a className="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white" onClick={logout}>Sign out</a>
                </li>
              </ul>
            </div>
          ...
          (<div className="flex items-center md:order-2"><button type="button" className="inline-block px-6 py-2.5 bg-yellow-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-yellow-600 hover:shadow-lg focus:bg-yellow-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-yellow-700 active:shadow-lg transition duration-150 ease-in-out" onClick={navLogin}>Login</button></div>)}
      </div>
      {/* {JSON.stringify(user) === JSON.stringify({}) ?
        <button onClick={() => navigate('/login')}>Login</button>
        :
